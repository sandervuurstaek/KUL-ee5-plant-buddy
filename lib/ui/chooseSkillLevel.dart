...
class ChooseSkillLevel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget topArea = Container(
      ...
      child: Column(
        children: [
          ...
          Text("How skilled are you at taking care of plants?",
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 45.sp,
    ...
    List<String> _skillLevelList=["Hopeless/The only plants that are still alive are the ones that never lived",
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image:AssetImage(_skillLevelImageList[index]),
                        fit: BoxFit.fill),
